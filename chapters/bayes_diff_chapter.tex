...
\begin{figure*}[!htb]
  ...
  \begin{subfigure}[b]{0.75\textwidth}
    ...
    \caption{{\small 
      Van Allen probe data used in section \S~\ref{sec:vanAllenData}. Time axis is 
      measured in hours from the starting point $5^{\text{th}}$ October $2012$. Red crosses indicate 
