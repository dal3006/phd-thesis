...
electrons and ions in complex electromagnetic orbits  \citet{vanAllen}. Since their discovery,
the belts have been the subject of intensive research due to their complex behavior
and damaging effects on spacecraft \citet{GUBBY20021723, WellingSatellite, baker2002}.
...
radiation belt dynamics \citet{schulz2012particle}.
...
so called Roederer $L^{*}$ \citet{Roederer1970}. It is analogous to radial 
...
(\citet{Roederer1970}, \citet{JGR:JGR4463}).
...
differential equation (\ref{eq:raddiffusion}) known as \emph{radial
  diffusion} in the radiation belt community\citet{JGRA:JGRA9345}.
...
global geomagnetic activity \citet{BartelsKp}.
...
\citet{MEHRKANOON2015105}, \citet{MEHRKANOON20122502} as well as
parameter estimation of delay differential equations
\citet{MEHRKANOON2014830}, the approach taken in the aforementioned
...
(\citet{AMINATAEI20082887}, \citet{DUAN200866}, \citet{DUAN2006394} \& \citet{CNM:CNM419}),
as well as the Poisson control problem \citet{Pearson2013}. Further applications of RBFs include 
atmospheric flow \citet{Tillenius2015406}, convection-diffusion \citet{Safdari-Vaighani2015}, and 
Schrödinger's equation \citet{doi:10.1137/120893975}. See ref. \citet{fornberg2015} for a recent 
textbook with geoscience applications.

\paragraph{Gaussian Processes}

Gaussian Process (GP) models \citet{Rasmussen:2005:GPM:1162254} have a rich theory which has much overlapping 
...
\citet{Lagaris}, \citet{Aarts2001} \&  \citet{TSOULOS20092385}. \citet{Baymani2011} used Feedforward networks for 
