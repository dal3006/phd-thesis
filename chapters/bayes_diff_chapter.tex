...
\begin{table}[t]
  ...
  \begin{tabular}{ll}
    ...
    \hline
    $\alpha$ & $\text{Uniform}(-5, 5)$ \\
    $\beta$  & $\text{Uniform}(0, 5)$ \\ 
    $b$ & $\text{Uniform}(0, 2)$ \\
    \hline
  \end{tabular}
\end{table}
...
\cref{fig:alpha,fig:beta,fig:b} while the samples from each prior distribution are shown 
in \cref{fig:alphaprior,fig:betaprior,fig:bprior}.
...
\begin{figure*}[!htb]
  ...
  \begin{subfigure}[b]{0.75\textwidth}
    ...
    \caption{ 
      Comparing samples drawn from the prior and posterior distributions of 
