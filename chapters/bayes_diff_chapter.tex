...
\noindent
    \parbox{\textwidth}{%
        {\small This chapter is based on research which is in preperation for publication. Research led by M. Chandorkar and supervised by 
        E. Camporeale. Y. Sphrits and A. Drozdov provided assistance in 
        processing Van Allen probe data.}
    }%
