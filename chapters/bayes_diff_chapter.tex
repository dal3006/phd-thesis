...
Partial differential equations are usually solved by approximating the derivatives involved on a spatiotemporal grid with numerical quadrature. Solving of a PDE system is referred to as the 
...
optimization in its dual form, it allows the inference to scale well with respect to high 
