...
The posterior inferred for parameters of the particle injection rate $Q$ \cref{fig:alpha,fig:beta,fig:gamma,fig:b} respectively and the samples from each prior distribution are shown in \cref{fig:alphaprior,fig:betaprior,fig:gammaprior,fig:bprior}.
