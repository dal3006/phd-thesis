...
used in section \S~\ref{sec:syntheticDataQ} above. Firstly, the synthetic data is randomly sampled 
...
inference, which is seen in section \S~\ref{sec:diffResults} below.  
