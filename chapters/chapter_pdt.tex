...
\centerline{  \begin{tabular}{| l c l l |}
  \hline
  Problem &  ${\scriptstyle f(v_t})$ & ${\scriptstyle g(\mathbf{x}_t)}$ & Other\\
  \hline
  \textbf{I} & ${\scriptstyle v_t}$ & ${\scriptstyle 5}$ & ${\scriptstyle k = 10,c=0}$\\
  \textbf{II} & ${\scriptstyle v_t}$ & ${\scriptstyle 100/v_t}$ & ${\scriptstyle k = 1, c = 10}$\\
  \textbf{III} & ${\scriptstyle \sqrt{v^2_{t} + 2ad}}$ & ${\scriptstyle (\sqrt{v_t^2 + 2ad} - v)/a}$ & ${\scriptstyle k = 5, a = 5, d = 1000, c = 100}$\\
  \textbf{IV} & ${\scriptstyle v_t}$ & ${\scriptstyle g(\mathbf{x}_t) = \exp\left(v_t\right)/\left(1 + \exp(v_t/20)\right)}$ & ${\scriptstyle k = 10, c = 40}$\\
  \hline
  \end{tabular}}
