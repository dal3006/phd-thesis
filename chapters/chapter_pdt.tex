...
\begin{enumerate}
    ...
    \item Zhou \& Sornette \citet{ZHOU2006195} enforce further assumptions 
...
Snoek et. al \citet{snoek2012practical} cast the problem in the formalism of Bayesian optimization, their method 
...
Bergstra et. al \citet{hypBengio} demonstrate that sequential hyper-parameter search techniques yield state of the art 
results when applied on \emph{Deep Belief Nets} (DBN). 

Bergstra \& Bengio \citet{randomsearchBengio} showed that random search can be an effective way for tuning model 
...
relationships do exist in real world data sets (\citet{doi:10.1002/jgra.50429}, \citet{ZHOU2006195}), 
...
In recent works \citet{Poduval_2014} \& \citet{neuralnetsw} FTE data has been used to
