...
Appendix \ref{app:opred}) the system involves three key statistical quantities, two global:
%
\begin{align}
...
\begin{table}
  \caption{
    Performance Comparison on CR $2077$: \XX  \ , Fixed Lag Base Line vs \citet{Riley2011}
  }
