...
The \emph{persistence model} can be described as \emph{Markovian} prediction mechanism, when it is 
...
by model selection. \Cref{table:modelselection} summarises the settings used to run each model 
selection procedure.
...
\Cref{fig:CompareMae,fig:CompareCC} show how the mean absolute error and coefficient of correlation 
