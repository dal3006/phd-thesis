...
$\mathbf{c}_{t}$. $\mathbf{h}_{t}$ (seen in figure \ref{fig:lstmcell}) becomes the final prediction computed 
...
$1$ and $0$ respectively. From table \ref{table:stormclass}, we constructed three binary classification problems 
