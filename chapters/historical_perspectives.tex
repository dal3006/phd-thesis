...
\begin{wrapfigure}{l}{0.3\textwidth}
    \centering\includegraphics[width=0.3\textwidth]{MokoShurai.jpg}
    \caption{
        {\small
...
\begin{figure}
    \centering\includegraphics[width=0.5\textwidth]{Great_Red_Spot_From_Voyager_1.jpg}
    \caption{
        {\small 
...
Space weather started gaining relevance with the rise of space missions, and increasing reliance on 
...
\begin{figure}
    \centering\includegraphics[width=0.5\textwidth]{spacex.jpg}
    \caption{
        {\small
