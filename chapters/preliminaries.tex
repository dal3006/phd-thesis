...
$400 \text{km}/\text{s}$ while its high speed component has an average velocity of $\sim 700 \text{km}/\text{s}$ 
(figure \ref{fig:solarwinddist}).

\begin{figure}
    \noindent\centering\includegraphics[width=0.75\textwidth]{solarwinddist.pdf}
    \caption{
        {\small Distribution of solar wind speed recorded at 1 AU for the time period $2008 - 2018$, Data Source: OMNI data \url{https://omniweb.gsfc.nasa.gov/ow.html}}}
