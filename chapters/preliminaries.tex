...
dominates the \emph{interplanetary magnetic field}. The Earth's magnetic field creates a cavity in space which is sheilded 
...
\begin{wrapfigure}{r}{0.4\textwidth}
    ...
    \caption{
        \small Periodic components of particle motion, Larmor gyration, bounce motion, drift motion. \\ 
        Reproduced from \citet{roederer2012dynamics}}
