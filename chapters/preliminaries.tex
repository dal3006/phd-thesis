...
the gas has almost equal amount of positive and negative charges, the mixture is electromagnetically 
...
\end{equation}
%
In \cref{eq:debye}, the Debye length scale is expressed in terms of the \emph{Boltzmann constant} $k_b$, 
...
The existence of the solar wind was first postulated via observations of Halley's comet in 
...
The HMF in steady state points radially outward and rotates with the Sun, producing an \emph{Archimedean spiral} 
